...
str = cellfun(@(x) num2str(P.adap_D0./x,3),num2cell(fliplr(vN)),'UniformOutput',false);

figure(70)
clf
boxplot(fliplr(mlinferr),str)
xlabel('$\frac{D_0}{d_0}$')
