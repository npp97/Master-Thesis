 ...
 * dV1_api.c
 *
 * Code generation for function 'dV1_api'
 *
...
static emlrtRTEInfo f_emlrtRTEI = { 1, 1, "dV1_api", "" };
...
void dV1_api(const mxArray *prhs[1], const mxArray *plhs[1])
{
  emxArray_real_T *r;
  emxArray_real_T *V;
  emlrtHeapReferenceStackEnterFcnR2012b(emlrtRootTLSGlobal);
  emxInit_real_T(&r, 2, &f_emlrtRTEI, TRUE);
  emxInit_real_T(&V, 2, &f_emlrtRTEI, TRUE);
...
/* End of code generation (dV1_api.c) */
