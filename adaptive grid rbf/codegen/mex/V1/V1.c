...
static emlrtRSInfo emlrtRSI = { 6, "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m" };

static emlrtRSInfo b_emlrtRSI = { 7, "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m" };
...
static emlrtRTEInfo c_emlrtRTEI = { 5, 5, "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m" };

static emlrtRTEInfo d_emlrtRTEI = { 20, 9, "eml_li_find",
  "/Applications/MATLAB_R2012b.app/toolbox/eml/lib/matlab/eml/eml_li_find.m" };

static emlrtECInfo emlrtECI = { -1, 6, 20, "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m" };

static emlrtECInfo b_emlrtECI = { -1, 7, 32, "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m" };

static emlrtECInfo c_emlrtECI = { -1, 7, 53, "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m" };

static emlrtECInfo d_emlrtECI = { -1, 7, 17, "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m" };

static emlrtECInfo e_emlrtECI = { -1, 6, 5, "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m" };

static emlrtECInfo f_emlrtECI = { -1, 7, 5, "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m" };

static emlrtBCInfo emlrtBCI = { -1, -1, 6, 5, "V", "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m", 0 };

static emlrtBCInfo b_emlrtBCI = { -1, -1, 6, 20, "r", "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m", 0 };

static emlrtBCInfo c_emlrtBCI = { -1, -1, 7, 32, "r", "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m", 0 };

static emlrtBCInfo d_emlrtBCI = { -1, -1, 7, 53, "r", "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m", 0 };

static emlrtBCInfo e_emlrtBCI = { -1, -1, 7, 5, "V", "V1",
  "/Users/schaluck/Documents/MATLAB/MT/adaptive grid rbf/V1.m", 0 };
...
void V1(emxArray_real_T *r, emxArray_real_T *V)
{
  ...
  emlrtMatrixMatrixIndexCheckR2012b(*(int32_T (*)[2])r->size, 2, *(int32_T (*)[1])
    r0->size, 1, &emlrtECI, emlrtRootTLSGlobal);
  emlrtPushRtStackR2012b(&emlrtRSI, emlrtRootTLSGlobal);
  eml_li_find(s, r2);
  i0 = r1->size[0];
  r1->size[0] = r2->size[0];
  ...
  for (i0 = 0; i0 < loop_ub; i0++) {
    ...
    i2 = r2->data[i0];
    r1->data[i0] = emlrtDynamicBoundsCheckFastR2012b(i2, 1, i1, &emlrtBCI,
      emlrtRootTLSGlobal);
  }
  ...
  emxInit_real_T(&r3, 1, &emlrtRTEI, TRUE);
  i0 = r3->size[0];
  r3->size[0] = r0->size[0];
  ...
  loop_ub = r0->size[0];
  for (i0 = 0; i0 < loop_ub; i0++) {
    r3->data[i0] = 0.0847 * r->data[r0->data[i0] - 1];
  }
  ...
  loop_ub = r3->size[0];
  for (i0 = 0; i0 < loop_ub; i0++) {
    V->data[r1->data[i0] - 1] = r3->data[i0];
  }
  ...
  emxInit_real_T(&r4, 1, &emlrtRTEI, TRUE);
  eml_li_find(c_s, r2);
  emlrtPopRtStackR2012b(&b_emlrtRSI, emlrtRootTLSGlobal);
  emlrtMatrixMatrixIndexCheckR2012b(*(int32_T (*)[2])r->size, 2, *(int32_T (*)[1])
    r2->size, 1, &c_emlrtECI, emlrtRootTLSGlobal);
  i0 = r4->size[0];
  r4->size[0] = r0->size[0];
  emxEnsureCapacity((emxArray__common *)r4, i0, (int32_T)sizeof(real_T),
                    &emlrtRTEI);
  loop_ub = r0->size[0];
  ...
  for (i0 = 0; i0 < loop_ub; i0++) {
    i1 = r->size[0] * r->size[1];
    i2 = r0->data[i0];
    r4->data[i0] = 1.0 - 5.0 * r->data[emlrtDynamicBoundsCheckFastR2012b(i2, 1,
  ...
  for (i0 = 0; i0 < loop_ub; i0++) {
    i1 = r->size[0] * r->size[1];
    i2 = r2->data[i0];
    r5->data[i0] = -4.0 * r->data[emlrtDynamicBoundsCheckFastR2012b(i2, 1, i1,
  ...
  for (i0 = 0; i0 < loop_ub; i0++) {
    ...
    i2 = r0->data[i0];
    r2->data[i0] = emlrtDynamicBoundsCheckFastR2012b(i2, 1, i1, &e_emlrtBCI,
      emlrtRootTLSGlobal);
  }
  ...
  loop_ub = b->size[0];
  for (i0 = 0; i0 < loop_ub; i0++) {
    V->data[r2->data[i0] - 1] = b->data[i0] - r3->data[i0];
  }
