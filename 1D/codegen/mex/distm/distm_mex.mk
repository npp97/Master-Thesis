...
MAKEFILE = distm_mex.mk

include distm_mex.mki
...
MEX_FILE_NAME_WO_EXT = distm_mex
...
SYS_INCLUDE += -I "/Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/distm"
...
%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/distm/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/distm/%.cu
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/distm/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
