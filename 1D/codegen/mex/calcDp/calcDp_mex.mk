...
MAKEFILE = calcDp_mex.mk

include calcDp_mex.mki
...
MEX_FILE_NAME_WO_EXT = calcDp_mex
...
SYS_INCLUDE += -I "/Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/calcDp"
...
%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/calcDp/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/calcDp/%.cu
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/calcDp/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
