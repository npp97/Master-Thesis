...
MAKEFILE = OrgEnergy_mex.mk

include OrgEnergy_mex.mki


SRC_FILES =  \
	OrgEnergy_mexutil.c \
	OrgEnergy_data.c \
	OrgEnergy_initialize.c \
	OrgEnergy_terminate.c \
	OrgEnergy.c \
	calcDp.c \
	distm.c \
	sum.c \
...
MEX_FILE_NAME_WO_EXT = OrgEnergy_mex
...
SYS_INCLUDE += -I "/Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/OrgEnergy"
...
%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/OrgEnergy/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/OrgEnergy/%.cu
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/OrgEnergy/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
