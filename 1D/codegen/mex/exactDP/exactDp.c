...
static emlrtRSInfo emlrtRSI = { 9, "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m" };

static emlrtRSInfo b_emlrtRSI = { 17, "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m" };

static emlrtRSInfo c_emlrtRSI = { 18, "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m" };

static emlrtRSInfo d_emlrtRSI = { 19, "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m" };
...
static emlrtRTEInfo emlrtRTEI = { 1, 15, "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m" };

static emlrtRTEInfo b_emlrtRTEI = { 17, 9, "eml_li_find",
  "/Applications/MATLAB_R2012b.app/toolbox/eml/lib/matlab/eml/eml_li_find.m" };

static emlrtRTEInfo c_emlrtRTEI = { 9, 5, "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m" };

static emlrtRTEInfo d_emlrtRTEI = { 17, 13, "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m" };

static emlrtECInfo emlrtECI = { -1, 19, 29, "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m" };

static emlrtBCInfo emlrtBCI = { -1, -1, 17, 45, "Dp", "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m", 0 };

static emlrtBCInfo b_emlrtBCI = { -1, -1, 17, 29, "Xp", "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m", 0 };

static emlrtBCInfo c_emlrtBCI = { -1, -1, 15, 37, "Dp", "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m", 0 };

static emlrtBCInfo d_emlrtBCI = { -1, -1, 13, 9, "Dp", "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m", 0 };

static emlrtBCInfo e_emlrtBCI = { -1, -1, 13, 17, "MF", "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m", 0 };

static emlrtBCInfo f_emlrtBCI = { -1, -1, 15, 29, "Dp", "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m", 0 };

static emlrtBCInfo g_emlrtBCI = { -1, -1, 16, 22, "Dp", "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m", 0 };

static emlrtBCInfo h_emlrtBCI = { -1, -1, 22, 17, "Dp", "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m", 0 };

static emlrtBCInfo i_emlrtBCI = { -1, -1, 22, 25, "MF", "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m", 0 };

static emlrtBCInfo j_emlrtBCI = { -1, -1, 19, 29, "MF", "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m", 0 };

static emlrtBCInfo k_emlrtBCI = { -1, -1, 19, 17, "Dp", "exactDp",
  "/Users/schaluck/Documents/MATLAB/MT/1D/exactDp.m", 0 };
...
void exactDp(const emxArray_real_T *Xp, const emxArray_real_T *DF, real_T rstar,
             real_T Dzero, emxArray_real_T *Dp)
{
  ...
  while (j - 1 <= Xp->size[0] - 1) {
    Dp_old = rtMinusInf;
    i0 = Dp->size[0];
    b_j = MF->size[0] * MF->size[1];
    Dp->data[emlrtDynamicBoundsCheckFastR2012b(j, 1, i0, &d_emlrtBCI,
      emlrtRootTLSGlobal) - 1] = MF->data[emlrtDynamicBoundsCheckFastR2012b(j, 1,
      b_j, &e_emlrtBCI, emlrtRootTLSGlobal) - 1];
    k = 0;
    do {
      exitg1 = 0;
      i0 = Dp->size[0];
      ...
      if ((muDoubleScalarAbs(x) / Dp->data[j - 1] > 0.01) && (k < 15)) {
        ...
        emxEnsureCapacity((emxArray__common *)b_Xp, i0, (int32_T)sizeof(real_T),
                          &emlrtRTEI);
        for (i0 = 0; i0 < loop_ub; i0++) {
          b_Xp->data[b_Xp->size[0] * i0] = Xp->data[(b_j + Xp->size[0] * i0) - 1];
        }
        ...
        if (x > 0.0) {
          ...
          for (i0 = 0; i0 < loop_ub; i0++) {
            b_j = MF->size[0] * MF->size[1];
            ixstart = r0->data[i0];
            emlrtDynamicBoundsCheckFastR2012b(ixstart, 1, b_j, &j_emlrtBCI,
              emlrtRootTLSGlobal);
          }
          ...
          i0 = Dp->size[0];
          Dp->data[emlrtDynamicBoundsCheckFastR2012b(j, 1, i0, &k_emlrtBCI,
          ...
          i0 = Dp->size[0];
          b_j = MF->size[0] * MF->size[1];
          Dp->data[emlrtDynamicBoundsCheckFastR2012b(j, 1, i0, &h_emlrtBCI,
            emlrtRootTLSGlobal) - 1] = MF->
            data[emlrtDynamicBoundsCheckFastR2012b(j, 1, b_j, &i_emlrtBCI,
...
/* End of code generation (exactDp.c) */
