...
MAKEFILE = exactDp_mex.mk

include exactDp_mex.mki
...
MEX_FILE_NAME_WO_EXT = exactDp_mex
...
SYS_INCLUDE += -I "/Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/exactDP"
...
%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/exactDP/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/exactDP/%.cu
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/exactDP/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
