...
MAKEFILE = Riley_mex.mk

include Riley_mex.mki
...
MEX_FILE_NAME_WO_EXT = Riley_mex
...
SYS_INCLUDE += -I "/Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/Riley"
...
%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/Riley/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/Riley/%.cu
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/schaluck/Documents/MATLAB/MT/1D/codegen/mex/Riley/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
